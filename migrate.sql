...
insert into SB.article_tag_maps(article_id,tag) select a.id,sca.title from  shantanubhadoria2.sb_content sc left join shantanubhadoria2.sb_categories sca on sc.catid=sca.id left join SB.articles a on sc.title=a.title; 
